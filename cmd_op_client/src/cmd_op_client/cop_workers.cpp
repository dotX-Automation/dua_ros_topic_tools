/**
 * Cmd Op client node worker threads routines.
 *
 * June 28, 2026
 */
...
void CmdOpClient::handle_arm()
{
  RCLCPP_WARN(get_logger(), "Arm command received");
...
void CmdOpClient::handle_disarm()
{
  RCLCPP_WARN(get_logger(), "Disarm command received");
...
void CmdOpClient::handle_kill()
{
  RCLCPP_WARN(get_logger(), "Kill command received");
...
void CmdOpClient::handle_reset()
{
  RCLCPP_WARN(get_logger(), "Reset command received");
